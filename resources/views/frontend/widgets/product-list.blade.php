				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item ">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							...
							<a href="{{ route('frontend.productDetail', ['id' => $sp->sp_ma]) }}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal" data-sp-ma="{{ $sp->sp_ma }}">
								Xem thông tin
							</a>
						</div>
